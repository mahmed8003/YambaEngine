...
public class PushButton extends BasicEntity {
	
	private TextureRegion[] regions;
	private TextureRegion region;
	private Sound sound = null;
	
	public PushButton(String name, TextureRegion region) {
		super(name);
		int cols = 2, rows = 1;
	...
	public PushButton(String name, float x, float y, TextureRegion region_up, TextureRegion region_down) {
		super(name);
